...
modulo::modulo(nodoModelo *hijo1, nodoModelo *hijo2, tablaSimbolos *tabla, token *signo):opModelo(hijo1,hijo2,tabla,signo){
}

itemValor *modulo::opModulo(elementoEntorno *entorno){
    ...
    */
    ...
    {
        tabla->tablaError->insertErrorSemantic("No se pueden operar [modulo] " + val1->valor->tipo + " con " + val2->valor->tipo, signo);
    }

    return retorno;
}

void modulo::println(QString mensaje)
{
    std::cout<<"[modulo]"<<mensaje.toStdString()<<std::endl;
}
