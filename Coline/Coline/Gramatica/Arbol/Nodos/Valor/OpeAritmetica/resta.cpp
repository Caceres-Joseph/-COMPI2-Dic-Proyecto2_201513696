...
resta::resta(nodoModelo *hijo1, nodoModelo *hijo2, tablaSimbolos *tabla, token *signo):opModelo(hijo1,hijo2,tabla,signo){
}

itemValor *resta::opResta(elementoEntorno *entorno){
    ...
    */
    ...
    {
        tabla->tablaError->insertErrorSemantic("No se pueden operar [RESTA] " + val1->valor->tipo + " con " + val2->valor->tipo, signo);
    }

    return retorno;
}

void resta::println(QString mensaje)
{
    std::cout<<"[resta]"<<mensaje.toStdString()<<std::endl;
}
