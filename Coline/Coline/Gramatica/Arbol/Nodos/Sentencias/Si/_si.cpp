...
itemRetorno* _SI::ejecutar(elementoEntorno *entor){
    tabla->comentarioLinea("si", entor->nivel);
    ...
    */
    ...
    elementoEntorno *entornoSi=new elementoEntorno(entor,tabla,"si",entor->este);
...
void _SI::cond1(itemValor *valor, elementoEntorno *entor)
// tSi  sAbreParent  E  sCierraParent  sAbreLlave  LST_CUERPO  sCierraLlave
{
...
void _SI::cond2(itemValor *valor, elementoEntorno *entor)
// tSi  sAbreParent  E  sCierraParent  sAbreLlave  LST_CUERPO  sCierraLlave  SINO_SI
{
...
void _SI::cond3(itemValor *valor, elementoEntorno *entor)
// tSi  sAbreParent  E  sCierraParent  sAbreLlave  LST_CUERPO  sCierraLlave  SINO
{
...
itemValor * _SI::operarCondicion(itemValor *valor,elementoEntorno *entor){
