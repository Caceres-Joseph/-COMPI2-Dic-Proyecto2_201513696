...
*/
itemRetorno* _DOWHILE::ejecutar(elementoEntorno *entor){
...
void _DOWHILE::cond1(itemValor *valor, elementoEntorno *entor, QString etqInicio)
...
itemValor * _DOWHILE::operarCondicion(itemValor *valor,elementoEntorno *entor){
