...
Relacional::Relacional(int linea, int columna, std::string archivo, tablaSimbolos *tabla, NodoAST *val1, NodoAST *val2, int operando):NodoAST (linea, columna, archivo, tabla)
{
    this->val1 = val1;
    this->val2 = val2;
